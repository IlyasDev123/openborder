...
<body>
    ...
    <p><span class="acuity-redactor-fix"><a href="http://www.bordercrossinglaw.com" target="_blank"
                        ...
                        <tbody>
                            <tr>
                                <td align="center"
                                    ...
                                    class="header-padding"><span style="color:rgb(0,0,0);"> Password Reset by Admin
                                    </span>
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2" align="left"
                                    ...
                                    class="custom-confirmation"><span style="color:rgb(0,0,0);"><span
                                            style="font-size:18px;">Your password has been changed.<br><br>
                                            <hr /><br>
                                            {{  $password  }}
                                            <br><br>
                                            <hr />
                                            ...
                                            help, you can <a href="https://bordercrossinglaw.as.me"
                                                style="color:#000000"; target="_blank">schedule a consultation by phone
                                                or video</a>, or <a href="https://bordercrossinglaw.com/services"
                                                style="color:#000000"; target="_blank">hire us for full
                                                ...
                                                <div class="wrapper">
                                                    <div class="advocating">
                                                        <div class="advocating-text">
                                                            <h2 style="color:grey"><img style="float: left; border-width: 100px; margin-left: 10px; margin-right: 10px;"
                                                                    src="https://wp.jaidenshannon.com/openborder/wp-content/uploads/2022/06/favicon.png"
                                                                    alt="" width="50"
                                                                    height="50" />Advocating for immigrants for more
                                                                than 15 years.</h2>
                                                            <p style="color:grey">The Border Crossing Law Firm is a
                                                                ...
                                                                <div class="footer-content">
                                                                    <div class="ft-menu">
                                                                        <ul id="menu-footer" class="menu">
                                                                            <li id="menu-item-726"
                                                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-726" style="color: grey">
                                                                                <a href="https://www.openborders.io"
                                                                                    style="color:grey">Open
                                                                                    Borders</a>
                                                                            </li>
                                                                            <li id="menu-item-566"
                                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-566" style="color: grey">
                                                                                <a
                                                                                    href="https://bordercrossinglaw.com/services"style="color:grey">Services
                                                                                    and Payment</a>
                                                                            </li>
                                                                            <li id="menu-item-502"
                                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-502" style="color: grey">
                                                                                <a
                                                                                    href="https://bordercrossinglaw.com/about"style="color:grey">About
                                                                                    The Firm</a>
                                                                            </li>
                                                                            <li id="menu-item-503"
                                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-503" style="color: grey">
                                                                                <a
                                                                                    href="https://bordercrossinglaw.com/contact"style="color:grey">Contact
                                                                                    Us</a>
                                                                            </li>
                                                                            <li id="menu-item-504"
                                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-504" style="color: grey">
                                                                                <a
                                                                                    href="https://bordercrossinglaw.com/news"style="color:grey">News</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                    <div class="contact-info">
                                                                        <span style="color:grey">(406) 594-2004 | (888) 595-2004 |
                                                                            Attorney@bordercrossinglaw.com <br></span>
                                                                        <span style="color:grey">618 Highland Street, Helena, Montana
                                                                            59601</span>
                                                                    </div>
                                                                    <div class="ft-rights">
                                                                        <p style="color:grey">
                                                                            ...
                                                                            All Rights Reserved. <br><a
                                                                                href="https://bordercrossinglaw.com/legaldisclaimersandtermsofuse"style="color:grey">
                                                                                Click here to review our Legal
                                                                                Disclaimers and Terms of Use
                                                                                Agreement.</a><br>Attorney Advertising.
