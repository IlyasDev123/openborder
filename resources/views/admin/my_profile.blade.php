					...
					<div class="card-body">
						<div class="tab-content">
							<div class="tab-pane active" id="edit_profile">
								<form class="form-horizontal" id="edit_profile_form" action="{{ route('admin.edit.profile')}}" method="post" enctype="multipart/form-data">
									@csrf
							...
							<div class="tab-pane" id="change_password">
								<form class="form-horizontal" id="change_password_form" action="{{ route('admin.change.password')}}" method="post" enctype="multipart/form-data">
									@csrf
									<div class="form-group row">
